...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
  ...
  <path fill="#ffffff" transform="scale(0.72) translate(2.2, 2.2)" d="M29,14h-2.2c-0.2-1.3-0.6-2.5-1.3-3.7c-0.7-1.3-0.5-3,0.6-4.1c0.4-0.4,0.4-1,0-1.4c-2-2-5.2-2-7.3-0.1
